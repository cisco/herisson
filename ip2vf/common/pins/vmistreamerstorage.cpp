...
CvMIStreamerStorage::CvMIStreamerStorage(const char* ip, const char* mcastgroup, int port, PinConfiguration *pconfig, const char* ifname) : CBasevMIStreamer(ip, mcastgroup, port, pconfig, ifname)
{
...
CvMIStreamerStorage::~CvMIStreamerStorage() {
...
int CvMIStreamerStorage::send(CvMIFrame* frame) {
...
bool CvMIStreamerStorage::isConnected() {
